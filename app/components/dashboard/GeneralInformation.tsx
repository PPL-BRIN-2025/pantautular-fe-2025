        ...
        <div className="bg-white text-black p-6 rounded-lg shadow-sm">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <AgeStatisticCard
                        data={[
                            { age: "<12 Tahun", value: data.age_statistics.under_12 },
                            { age: "12-25 Tahun", value: data.age_statistics["12_25"] },
                            { age: "26-45 Tahun", value: data.age_statistics["26_45"] },
                            { age: ">45 Tahun", value: data.age_statistics.above_45 }
                        ]}
                    />
